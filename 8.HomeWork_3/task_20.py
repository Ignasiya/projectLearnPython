...
scrable = {"A": 1, "E": 1, "I": 1, "O": 1, "U": 1, "L": 1, "N": 1, "S": 1, "T": 1, "R": 1,
          ...
          "Y": 4, "Й": 4, "Ы": 5, "K": 5, "Ж": 5, "З": 5, "Х": 5, "Ц": 5, "Ч": 5, "J": 8, 
          "X": 8, "Ш": 8, "Э": 8, "Ю": 8, "Q": 10, "Z": 10, "Ф": 10, "Щ": 10, "Ъ": 10}

wordInput = input("Enter the word for scrabble: ").upper()
...
for letter in wordInput:
    for (key, value) in scrable.items():
        if letter == key:
            result += value
            break
print(f"The cost of the entered word {wordInput} is equal to {result}")
